...
packages. Completions send `stream: true`, print each Azure chunk immediately,
then parse the assembled JSON. The entrypoint still commits only drafts and state. The local
